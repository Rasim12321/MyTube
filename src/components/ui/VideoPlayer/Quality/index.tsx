...
export function SelectQuality({ currentValue, onChange, maxResolution }: Props) {
  ...
  return (
    <div className='relative' ref={ref}>
      <button onClick={() => setIsShow(!isShow)} className='hover:text-primary transition-colors'>
        {currentValue}
      </button>
      ...
      <AnimatePresence>
        {isShow && (
          <m.ul
            ...
            className='absolute right-0 bottom-[125%] z-10 rounded bg-gray-800/80 px-4 py-2 shadow'
          >
